...
Y verificamos que los datos se han importado correstamente a la base de datos de SQL server : 
...
Hacemos conexion con nuestro nombre de servidor y el nombre de la base de datos la cual se desea importar : 
...
Se hizo un filtrado por hashtag  y descripcion segun el tweet : 
...
Y listo asi se realizo el procedimiento y ejecucion de la fuente 1. 
