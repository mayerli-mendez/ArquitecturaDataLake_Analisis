...
Para ello lo primero que se realizo es crear una base de datos en MYSQL llamada "covidproyecto":
...
Y verificamos que los datos se han importado, ingresando a la tabla en la base de datos covidproyecto : 
